  ...
  Widget build(BuildContext context) {
    ...
    final _greetingHeader = Column(
        ...
        children: [
          SizedBox(height: 20,),
          Text(
            "Hello, Anonymous", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.white),
          ),
          SizedBox(height: 14,),
          Text(
            "Your Coupons are Expiring Soon", style: TextStyle(fontSize: 16, color: HexColor.fromHex(TextGray)),
          ),
          SizedBox(height: 12,),
        ]
    );
